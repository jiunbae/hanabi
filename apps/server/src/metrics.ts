...
export const llmCallDurationSeconds = new Histogram({
  name: 'nolbul_llm_call_duration_seconds',
...
export const llmFallbacksTotal = new Counter({
  name: 'nolbul_llm_fallbacks_total',
